...
import com.otterly76.ott.entity.variant.ZombieVariant;
...
public class ZombieGeoModel<T extends Zombie & ZombieGeoEntity> extends GeoModel<T> {
    @Override
    public ResourceLocation getModelResource(T animatable) {
        return Ott.resource("geo/entity/zombie/zombie.geo.json");
    }
    ...
    public ResourceLocation getTextureResource(T animatable) {
        ...
        if (holder != null) {
            ...
            if (variant.isPresent() && variant.get() instanceof ZombieVariant zombieVariant) {
                ClientAsset asset = zombieVariant.modelAndTexture().asset();
        ...
        return Ott.resource("textures/entity/zombie/zombie_1.png");
    }
