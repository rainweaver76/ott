...
public final class EngravingEntries {
    ...
    private static void enumerateSolid(Sink s) {
        ...
        // ── Previously-uncategorized stone-family CTM variants → engrave 1:1 from base material ──
        // Data-driven: each decorative variant from its stone's material tag; auto-places in the Engraved tab.
        ...
        // cut sandstone column variants (uncategorized) → engrave from their sandstone base
        ...
        // ── Remaining uncategorized decorative CTM variants → engrave from base material ──
        // Stone pillars (curly/fine/ornate/simple) -> stone tag; colored glass -> its <color>_stained_glass; misc -> its material.
        ...
        // ── Glass decoratives folded into their material groups ──
