...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> SOUL_GLASS = register("soul_glass",
            () -> new Block(Properties.of().strength(0.3F).sound(SoundType.GLASS).noOcclusion()));
    ...
    public static final DeferredBlock<Block> ARCHED_BLACK_STAINED_GLASS_PILLAR =
        register("arched_black_stained_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_STAINED_GLASS)));
    public static final DeferredBlock<Block> FANCY_BLACK_STAINED_GLASS =
        register("fancy_black_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_STAINED_GLASS)));
    public static final DeferredBlock<Block> ORNATE_BLACK_STAINED_GLASS =
        register("ornate_black_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_STAINED_GLASS)));
    public static final DeferredBlock<Block> RASTER_BLACK_STAINED_GLASS =
        register("raster_black_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_STAINED_GLASS)));
    public static final DeferredBlock<Block> SMALL_BLACK_STAINED_GLASS =
        register("small_black_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_STAINED_GLASS)));
    public static final DeferredBlock<Block> TILED_BLACK_STAINED_GLASS =
        register("tiled_black_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_STAINED_GLASS)));
    ...
    public static final DeferredBlock<Block> ARCHED_BLUE_STAINED_GLASS_PILLAR =
        register("arched_blue_stained_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLUE_STAINED_GLASS)));
    public static final DeferredBlock<Block> FANCY_BLUE_STAINED_GLASS =
        register("fancy_blue_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLUE_STAINED_GLASS)));
    public static final DeferredBlock<Block> ORNATE_BLUE_STAINED_GLASS =
        register("ornate_blue_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLUE_STAINED_GLASS)));
    public static final DeferredBlock<Block> RASTER_BLUE_STAINED_GLASS =
        register("raster_blue_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLUE_STAINED_GLASS)));
    public static final DeferredBlock<Block> SMALL_BLUE_STAINED_GLASS =
        register("small_blue_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLUE_STAINED_GLASS)));
    public static final DeferredBlock<Block> TILED_BLUE_STAINED_GLASS =
        register("tiled_blue_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLUE_STAINED_GLASS)));
    ...
    public static final DeferredBlock<Block> ARCHED_BROWN_STAINED_GLASS_PILLAR =
        register("arched_brown_stained_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BROWN_STAINED_GLASS)));
    public static final DeferredBlock<Block> FANCY_BROWN_STAINED_GLASS =
        register("fancy_brown_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BROWN_STAINED_GLASS)));
    public static final DeferredBlock<Block> ORNATE_BROWN_STAINED_GLASS =
        register("ornate_brown_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BROWN_STAINED_GLASS)));
    public static final DeferredBlock<Block> RASTER_BROWN_STAINED_GLASS =
        register("raster_brown_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BROWN_STAINED_GLASS)));
    public static final DeferredBlock<Block> SMALL_BROWN_STAINED_GLASS =
        register("small_brown_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BROWN_STAINED_GLASS)));
    public static final DeferredBlock<Block> TILED_BROWN_STAINED_GLASS =
        register("tiled_brown_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BROWN_STAINED_GLASS)));
    ...
    public static final DeferredBlock<Block> ARCHED_CYAN_STAINED_GLASS_PILLAR =
        register("arched_cyan_stained_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.CYAN_STAINED_GLASS)));
    public static final DeferredBlock<Block> FANCY_CYAN_STAINED_GLASS =
        register("fancy_cyan_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.CYAN_STAINED_GLASS)));
    public static final DeferredBlock<Block> ORNATE_CYAN_STAINED_GLASS =
        register("ornate_cyan_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.CYAN_STAINED_GLASS)));
    public static final DeferredBlock<Block> RASTER_CYAN_STAINED_GLASS =
        register("raster_cyan_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.CYAN_STAINED_GLASS)));
    public static final DeferredBlock<Block> SMALL_CYAN_STAINED_GLASS =
        register("small_cyan_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.CYAN_STAINED_GLASS)));
    public static final DeferredBlock<Block> TILED_CYAN_STAINED_GLASS =
        register("tiled_cyan_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.CYAN_STAINED_GLASS)));
    ...
    public static final DeferredBlock<Block> ARCHED_GRAY_STAINED_GLASS_PILLAR =
        register("arched_gray_stained_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GRAY_STAINED_GLASS)));
    public static final DeferredBlock<Block> FANCY_GRAY_STAINED_GLASS =
        register("fancy_gray_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GRAY_STAINED_GLASS)));
    public static final DeferredBlock<Block> ORNATE_GRAY_STAINED_GLASS =
        register("ornate_gray_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GRAY_STAINED_GLASS)));
    public static final DeferredBlock<Block> RASTER_GRAY_STAINED_GLASS =
        register("raster_gray_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GRAY_STAINED_GLASS)));
    public static final DeferredBlock<Block> SMALL_GRAY_STAINED_GLASS =
        register("small_gray_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GRAY_STAINED_GLASS)));
    public static final DeferredBlock<Block> TILED_GRAY_STAINED_GLASS =
        register("tiled_gray_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GRAY_STAINED_GLASS)));
    ...
    public static final DeferredBlock<Block> ARCHED_GREEN_STAINED_GLASS_PILLAR =
        register("arched_green_stained_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GREEN_STAINED_GLASS)));
    public static final DeferredBlock<Block> FANCY_GREEN_STAINED_GLASS =
        register("fancy_green_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GREEN_STAINED_GLASS)));
    public static final DeferredBlock<Block> ORNATE_GREEN_STAINED_GLASS =
        register("ornate_green_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GREEN_STAINED_GLASS)));
    public static final DeferredBlock<Block> RASTER_GREEN_STAINED_GLASS =
        register("raster_green_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GREEN_STAINED_GLASS)));
    public static final DeferredBlock<Block> SMALL_GREEN_STAINED_GLASS =
        register("small_green_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GREEN_STAINED_GLASS)));
    public static final DeferredBlock<Block> TILED_GREEN_STAINED_GLASS =
        register("tiled_green_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GREEN_STAINED_GLASS)));
    ...
    public static final DeferredBlock<Block> ARCHED_LEADED_GLASS_PILLAR =
        register("arched_leaded_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GLASS)));
    public static final DeferredBlock<Block> ORNATE_LEADED_GLASS =
        register("ornate_leaded_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GLASS)));
    public static final DeferredBlock<Block> RASTER_LEADED_GLASS =
        register("raster_leaded_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GLASS)));
    public static final DeferredBlock<Block> SMALL_DIAMOND_LEADED_GLASS =
        register("small_diamond_leaded_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GLASS)));
    ...
    public static final DeferredBlock<Block> ARCHED_LIGHT_BLUE_STAINED_GLASS_PILLAR =
        register("arched_light_blue_stained_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_BLUE_STAINED_GLASS)));
    public static final DeferredBlock<Block> FANCY_LIGHT_BLUE_STAINED_GLASS =
        register("fancy_light_blue_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_BLUE_STAINED_GLASS)));
    public static final DeferredBlock<Block> ORNATE_LIGHT_BLUE_STAINED_GLASS =
        register("ornate_light_blue_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_BLUE_STAINED_GLASS)));
    public static final DeferredBlock<Block> RASTER_LIGHT_BLUE_STAINED_GLASS =
        register("raster_light_blue_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_BLUE_STAINED_GLASS)));
    public static final DeferredBlock<Block> SMALL_LIGHT_BLUE_STAINED_GLASS =
        register("small_light_blue_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_BLUE_STAINED_GLASS)));
    public static final DeferredBlock<Block> TILED_LIGHT_BLUE_STAINED_GLASS =
        register("tiled_light_blue_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_BLUE_STAINED_GLASS)));
    ...
    public static final DeferredBlock<Block> ARCHED_LIGHT_GRAY_STAINED_GLASS_PILLAR =
        register("arched_light_gray_stained_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_GRAY_STAINED_GLASS)));
    public static final DeferredBlock<Block> FANCY_LIGHT_GRAY_STAINED_GLASS =
        register("fancy_light_gray_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_GRAY_STAINED_GLASS)));
    public static final DeferredBlock<Block> ORNATE_LIGHT_GRAY_STAINED_GLASS =
        register("ornate_light_gray_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_GRAY_STAINED_GLASS)));
    public static final DeferredBlock<Block> RASTER_LIGHT_GRAY_STAINED_GLASS =
        register("raster_light_gray_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_GRAY_STAINED_GLASS)));
    public static final DeferredBlock<Block> SMALL_LIGHT_GRAY_STAINED_GLASS =
        register("small_light_gray_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_GRAY_STAINED_GLASS)));
    public static final DeferredBlock<Block> TILED_LIGHT_GRAY_STAINED_GLASS =
        register("tiled_light_gray_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_GRAY_STAINED_GLASS)));
    ...
    public static final DeferredBlock<Block> ARCHED_LIME_STAINED_GLASS_PILLAR =
        register("arched_lime_stained_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIME_STAINED_GLASS)));
    public static final DeferredBlock<Block> FANCY_LIME_STAINED_GLASS =
        register("fancy_lime_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIME_STAINED_GLASS)));
    public static final DeferredBlock<Block> ORNATE_LIME_STAINED_GLASS =
        register("ornate_lime_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIME_STAINED_GLASS)));
    public static final DeferredBlock<Block> RASTER_LIME_STAINED_GLASS =
        register("raster_lime_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIME_STAINED_GLASS)));
    public static final DeferredBlock<Block> SMALL_LIME_STAINED_GLASS =
        register("small_lime_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIME_STAINED_GLASS)));
    public static final DeferredBlock<Block> TILED_LIME_STAINED_GLASS =
        register("tiled_lime_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LIME_STAINED_GLASS)));
    ...
    public static final DeferredBlock<Block> ARCHED_MAGENTA_STAINED_GLASS_PILLAR =
        register("arched_magenta_stained_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.MAGENTA_STAINED_GLASS)));
    public static final DeferredBlock<Block> FANCY_MAGENTA_STAINED_GLASS =
        register("fancy_magenta_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.MAGENTA_STAINED_GLASS)));
    public static final DeferredBlock<Block> ORNATE_MAGENTA_STAINED_GLASS =
        register("ornate_magenta_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.MAGENTA_STAINED_GLASS)));
    public static final DeferredBlock<Block> RASTER_MAGENTA_STAINED_GLASS =
        register("raster_magenta_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.MAGENTA_STAINED_GLASS)));
    public static final DeferredBlock<Block> SMALL_MAGENTA_STAINED_GLASS =
        register("small_magenta_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.MAGENTA_STAINED_GLASS)));
    public static final DeferredBlock<Block> TILED_MAGENTA_STAINED_GLASS =
        register("tiled_magenta_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.MAGENTA_STAINED_GLASS)));
    ...
    public static final DeferredBlock<Block> ARCHED_ORANGE_STAINED_GLASS_PILLAR =
        register("arched_orange_stained_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.ORANGE_STAINED_GLASS)));
    public static final DeferredBlock<Block> FANCY_ORANGE_STAINED_GLASS =
        register("fancy_orange_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.ORANGE_STAINED_GLASS)));
    public static final DeferredBlock<Block> ORNATE_ORANGE_STAINED_GLASS =
        register("ornate_orange_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.ORANGE_STAINED_GLASS)));
    public static final DeferredBlock<Block> RASTER_ORANGE_STAINED_GLASS =
        register("raster_orange_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.ORANGE_STAINED_GLASS)));
    public static final DeferredBlock<Block> SMALL_ORANGE_STAINED_GLASS =
        register("small_orange_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.ORANGE_STAINED_GLASS)));
    public static final DeferredBlock<Block> TILED_ORANGE_STAINED_GLASS =
        register("tiled_orange_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.ORANGE_STAINED_GLASS)));
    ...
    public static final DeferredBlock<Block> ARCHED_PINK_STAINED_GLASS_PILLAR =
        register("arched_pink_stained_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.PINK_STAINED_GLASS)));
    public static final DeferredBlock<Block> FANCY_PINK_STAINED_GLASS =
        register("fancy_pink_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.PINK_STAINED_GLASS)));
    public static final DeferredBlock<Block> ORNATE_PINK_STAINED_GLASS =
        register("ornate_pink_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.PINK_STAINED_GLASS)));
    public static final DeferredBlock<Block> RASTER_PINK_STAINED_GLASS =
        register("raster_pink_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.PINK_STAINED_GLASS)));
    public static final DeferredBlock<Block> SMALL_PINK_STAINED_GLASS =
        register("small_pink_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.PINK_STAINED_GLASS)));
    public static final DeferredBlock<Block> TILED_PINK_STAINED_GLASS =
        register("tiled_pink_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.PINK_STAINED_GLASS)));
    ...
    public static final DeferredBlock<Block> ARCHED_PURPLE_STAINED_GLASS_PILLAR =
        register("arched_purple_stained_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.PURPLE_STAINED_GLASS)));
    public static final DeferredBlock<Block> FANCY_PURPLE_STAINED_GLASS =
        register("fancy_purple_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.PURPLE_STAINED_GLASS)));
    public static final DeferredBlock<Block> ORNATE_PURPLE_STAINED_GLASS =
        register("ornate_purple_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.PURPLE_STAINED_GLASS)));
    public static final DeferredBlock<Block> RASTER_PURPLE_STAINED_GLASS =
        register("raster_purple_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.PURPLE_STAINED_GLASS)));
    public static final DeferredBlock<Block> SMALL_PURPLE_STAINED_GLASS =
        register("small_purple_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.PURPLE_STAINED_GLASS)));
    public static final DeferredBlock<Block> TILED_PURPLE_STAINED_GLASS =
        register("tiled_purple_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.PURPLE_STAINED_GLASS)));
    ...
    public static final DeferredBlock<Block> ARCHED_RED_STAINED_GLASS_PILLAR =
        register("arched_red_stained_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_STAINED_GLASS)));
    public static final DeferredBlock<Block> FANCY_RED_STAINED_GLASS =
        register("fancy_red_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_STAINED_GLASS)));
    public static final DeferredBlock<Block> ORNATE_RED_STAINED_GLASS =
        register("ornate_red_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_STAINED_GLASS)));
    public static final DeferredBlock<Block> RASTER_RED_STAINED_GLASS =
        register("raster_red_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_STAINED_GLASS)));
    public static final DeferredBlock<Block> SMALL_RED_STAINED_GLASS =
        register("small_red_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_STAINED_GLASS)));
    public static final DeferredBlock<Block> TILED_RED_STAINED_GLASS =
        register("tiled_red_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_STAINED_GLASS)));
    ...
    public static final DeferredBlock<Block> ARCHED_WHITE_STAINED_GLASS_PILLAR =
        register("arched_white_stained_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_STAINED_GLASS)));
    public static final DeferredBlock<Block> FANCY_WHITE_STAINED_GLASS =
        register("fancy_white_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_STAINED_GLASS)));
    public static final DeferredBlock<Block> ORNATE_WHITE_STAINED_GLASS =
        register("ornate_white_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_STAINED_GLASS)));
    public static final DeferredBlock<Block> RASTER_WHITE_STAINED_GLASS =
        register("raster_white_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_STAINED_GLASS)));
    public static final DeferredBlock<Block> SMALL_WHITE_STAINED_GLASS =
        register("small_white_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_STAINED_GLASS)));
    public static final DeferredBlock<Block> TILED_WHITE_STAINED_GLASS =
        register("tiled_white_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_STAINED_GLASS)));
    ...
    public static final DeferredBlock<Block> ARCHED_YELLOW_STAINED_GLASS_PILLAR =
        register("arched_yellow_stained_glass_pillar", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.YELLOW_STAINED_GLASS)));
    public static final DeferredBlock<Block> FANCY_YELLOW_STAINED_GLASS =
        register("fancy_yellow_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.YELLOW_STAINED_GLASS)));
    public static final DeferredBlock<Block> ORNATE_YELLOW_STAINED_GLASS =
        register("ornate_yellow_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.YELLOW_STAINED_GLASS)));
    public static final DeferredBlock<Block> RASTER_YELLOW_STAINED_GLASS =
        register("raster_yellow_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.YELLOW_STAINED_GLASS)));
    public static final DeferredBlock<Block> SMALL_YELLOW_STAINED_GLASS =
        register("small_yellow_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.YELLOW_STAINED_GLASS)));
    public static final DeferredBlock<Block> TILED_YELLOW_STAINED_GLASS =
        register("tiled_yellow_stained_glass", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.YELLOW_STAINED_GLASS)));
    ...
    public static final DeferredBlock<Block> ACACIA_WINDOW_TILES = register("acacia_window_tiles", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BIRCH_WINDOW_TILES = register("birch_window_tiles", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CRIMSON_WINDOW_TILES = register("crimson_window_tiles", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> DARK_OAK_WINDOW_TILES = register("dark_oak_window_tiles", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> JUNGLE_WINDOW_TILES = register("jungle_window_tiles", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> MANGROVE_WINDOW_TILES = register("mangrove_window_tiles", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> OAK_WINDOW_TILES = register("oak_window_tiles", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SPRUCE_WINDOW_TILES = register("spruce_window_tiles", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> WARPED_WINDOW_TILES = register("warped_window_tiles", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> BLACK_FRAMED_GLASS = register("black_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BLACK_STAINED_CLEAR_GLASS = register("black_stained_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BLUE_FRAMED_GLASS = register("blue_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BLUE_STAINED_CLEAR_GLASS = register("blue_stained_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> BROWN_FRAMED_GLASS = register("brown_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BROWN_STAINED_CLEAR_GLASS = register("brown_stained_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> CHISELED_GLASS = register("chiseled_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CLEAR_GLASS = register("clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> CYAN_FRAMED_GLASS = register("cyan_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CYAN_STAINED_CLEAR_GLASS = register("cyan_stained_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> DIRTY_GLASS = register("dirty_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> FRAMED_GLASS = register("framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> FROSTED_GLASS = register("frosted_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GLASS = register("glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> GOLDEN_FRAMED_BLACK_STAINED_GLASS = register("golden_framed_black_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GOLDEN_FRAMED_BLUE_STAINED_GLASS = register("golden_framed_blue_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GOLDEN_FRAMED_BROWN_STAINED_GLASS = register("golden_framed_brown_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GOLDEN_FRAMED_CYAN_STAINED_GLASS = register("golden_framed_cyan_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GOLDEN_FRAMED_GRAY_STAINED_GLASS = register("golden_framed_gray_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GOLDEN_FRAMED_GREEN_STAINED_GLASS = register("golden_framed_green_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GOLDEN_FRAMED_LIGHT_BLUE = register("golden_framed_light_blue", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GOLDEN_FRAMED_LIGHT_GRAY_STAINED_GLASS = register("golden_framed_light_gray_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GOLDEN_FRAMED_LIME_STAINED_GLASS = register("golden_framed_lime_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GOLDEN_FRAMED_MAGENTA_STAINED_GLASS = register("golden_framed_magenta_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GOLDEN_FRAMED_ORANGE_STAINED_GLASS = register("golden_framed_orange_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GOLDEN_FRAMED_PINK_STAINED_GLASS = register("golden_framed_pink_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GOLDEN_FRAMED_PURPLE_STAINED_GLASS = register("golden_framed_purple_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GOLDEN_FRAMED_RED_STAINED_GLASS = register("golden_framed_red_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GOLDEN_FRAMED_STAINED_GLASS = register("golden_framed_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GOLDEN_FRAMED_WHITE_STAINED_GLASS = register("golden_framed_white_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GOLDEN_FRAMED_YELLOW_STAINED_GLASS = register("golden_framed_yellow_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> GRAY_FRAMED_GLASS = register("gray_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GRAY_STAINED_CLEAR_GLASS = register("gray_stained_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GREEN_FRAMED_GLASS = register("green_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GREEN_STAINED_CLEAR_GLASS = register("green_stained_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> LIGHT_BLUE_FRAMED_GLASS = register("light_blue_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> LIGHT_BLUE_STAINED_CLEAR_GLASS = register("light_blue_stained_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> LIGHT_GRAY_FRAMED_GLASS = register("light_gray_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> LIGHT_GRAY_STAINED_CLEAR_GLASS = register("light_gray_stained_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> LIME_FRAMED_GLASS = register("lime_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> LIME_STAINED_CLEAR_GLASS = register("lime_stained_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> MAGENTA_FRAMED_GLASS = register("magenta_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> MAGENTA_STAINED_CLEAR_GLASS = register("magenta_stained_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> OBSIDIAN_FRAMED_GLASS = register("obsidian_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> ORANGE_FRAMED_GLASS = register("orange_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> ORANGE_STAINED_CLEAR_GLASS = register("orange_stained_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> PINK_FRAMED_GLASS = register("pink_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> PINK_STAINED_CLEAR_GLASS = register("pink_stained_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> PURPLE_FRAMED_GLASS = register("purple_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> PURPLE_STAINED_CLEAR_GLASS = register("purple_stained_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> RED_FRAMED_GLASS = register("red_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> RED_STAINED_CLEAR_GLASS = register("red_stained_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> SANDSTONE_FRAMED_GLASS = register("sandstone_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> STONE_FRAMED_GLASS = register("stone_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_CLEAR_GLASS = register("tinted_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> WHITE_FRAMED_GLASS = register("white_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> WHITE_STAINED_CLEAR_GLASS = register("white_stained_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> YELLOW_FRAMED_GLASS = register("yellow_framed_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> YELLOW_STAINED_CLEAR_GLASS = register("yellow_stained_clear_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> BLACK_STAINED_GLASS = register("black_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> BLUE_STAINED_GLASS = register("blue_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> BORDERLESS_GLASS = register("borderless_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BORDERLESS_GLASS_BLACK = register("borderless_glass_black", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BORDERLESS_GLASS_BLUE = register("borderless_glass_blue", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BORDERLESS_GLASS_BROWN = register("borderless_glass_brown", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BORDERLESS_GLASS_CYAN = register("borderless_glass_cyan", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BORDERLESS_GLASS_GRAY = register("borderless_glass_gray", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BORDERLESS_GLASS_GREEN = register("borderless_glass_green", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BORDERLESS_GLASS_LIGHT_BLUE = register("borderless_glass_light_blue", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BORDERLESS_GLASS_LIGHT_GRAY = register("borderless_glass_light_gray", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BORDERLESS_GLASS_LIME = register("borderless_glass_lime", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BORDERLESS_GLASS_MAGENTA = register("borderless_glass_magenta", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BORDERLESS_GLASS_ORANGE = register("borderless_glass_orange", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BORDERLESS_GLASS_PINK = register("borderless_glass_pink", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BORDERLESS_GLASS_PURPLE = register("borderless_glass_purple", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BORDERLESS_GLASS_RED = register("borderless_glass_red", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BORDERLESS_GLASS_WHITE = register("borderless_glass_white", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BORDERLESS_GLASS_YELLOW = register("borderless_glass_yellow", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BROWN_STAINED_GLASS = register("brown_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> CLEAR_GLASS_BLACK = register("clear_glass_black", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CLEAR_GLASS_BLUE = register("clear_glass_blue", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CLEAR_GLASS_BROWN = register("clear_glass_brown", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CLEAR_GLASS_CYAN = register("clear_glass_cyan", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CLEAR_GLASS_GRAY = register("clear_glass_gray", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CLEAR_GLASS_GREEN = register("clear_glass_green", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CLEAR_GLASS_LIGHT_BLUE = register("clear_glass_light_blue", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CLEAR_GLASS_LIGHT_GRAY = register("clear_glass_light_gray", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CLEAR_GLASS_LIME = register("clear_glass_lime", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CLEAR_GLASS_MAGENTA = register("clear_glass_magenta", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CLEAR_GLASS_ORANGE = register("clear_glass_orange", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CLEAR_GLASS_PINK = register("clear_glass_pink", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CLEAR_GLASS_PURPLE = register("clear_glass_purple", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CLEAR_GLASS_RED = register("clear_glass_red", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CLEAR_GLASS_WHITE = register("clear_glass_white", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CLEAR_GLASS_YELLOW = register("clear_glass_yellow", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> CYAN_STAINED_GLASS = register("cyan_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> ECHO_GLASS = register("echo_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> ECHO_GLASS_1 = register("echo_glass_1", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> ECHO_GLASS_2 = register("echo_glass_2", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> ECHO_GLASS_3 = register("echo_glass_3", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> GRAY_STAINED_GLASS = register("gray_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> GREEN_STAINED_GLASS = register("green_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> ICE_GLASS = register("ice_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> IRON_BLOCK_FRAMED = register("iron_block_framed", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> LIGHT_BLUE_STAINED_GLASS = register("light_blue_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> LIGHT_GRAY_STAINED_GLASS = register("light_gray_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> LIME_STAINED_GLASS = register("lime_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> MAGENTA_STAINED_GLASS = register("magenta_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> ORANGE_STAINED_GLASS = register("orange_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> PINK_STAINED_GLASS = register("pink_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> PURPLE_STAINED_GLASS = register("purple_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> QUICKSOIL_GLASS = register("quicksoil_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> RED_STAINED_GLASS = register("red_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> REINFORCED_GLASS = register("reinforced_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> SCRATCHED_GLASS = register("scratched_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SCRATCHED_GLASS_BLACK = register("scratched_glass_black", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SCRATCHED_GLASS_BLUE = register("scratched_glass_blue", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SCRATCHED_GLASS_BROWN = register("scratched_glass_brown", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SCRATCHED_GLASS_CYAN = register("scratched_glass_cyan", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SCRATCHED_GLASS_GRAY = register("scratched_glass_gray", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SCRATCHED_GLASS_GREEN = register("scratched_glass_green", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SCRATCHED_GLASS_LIGHT_BLUE = register("scratched_glass_light_blue", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SCRATCHED_GLASS_LIGHT_GRAY = register("scratched_glass_light_gray", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SCRATCHED_GLASS_LIME = register("scratched_glass_lime", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SCRATCHED_GLASS_MAGENTA = register("scratched_glass_magenta", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SCRATCHED_GLASS_ORANGE = register("scratched_glass_orange", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SCRATCHED_GLASS_PINK = register("scratched_glass_pink", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SCRATCHED_GLASS_PURPLE = register("scratched_glass_purple", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SCRATCHED_GLASS_RED = register("scratched_glass_red", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SCRATCHED_GLASS_WHITE = register("scratched_glass_white", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SCRATCHED_GLASS_YELLOW = register("scratched_glass_yellow", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS = register("tinted_borderless_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS_BLACK = register("tinted_borderless_glass_black", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS_BLUE = register("tinted_borderless_glass_blue", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS_BROWN = register("tinted_borderless_glass_brown", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS_CYAN = register("tinted_borderless_glass_cyan", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS_GRAY = register("tinted_borderless_glass_gray", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS_GREEN = register("tinted_borderless_glass_green", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS_LIGHT_BLUE = register("tinted_borderless_glass_light_blue", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS_LIGHT_GRAY = register("tinted_borderless_glass_light_gray", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS_LIME = register("tinted_borderless_glass_lime", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS_MAGENTA = register("tinted_borderless_glass_magenta", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS_ORANGE = register("tinted_borderless_glass_orange", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS_PINK = register("tinted_borderless_glass_pink", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS_PURPLE = register("tinted_borderless_glass_purple", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS_RED = register("tinted_borderless_glass_red", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS_WHITE = register("tinted_borderless_glass_white", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_BORDERLESS_GLASS_YELLOW = register("tinted_borderless_glass_yellow", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> TINTED_GLASS = register("tinted_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> WHITE_STAINED_GLASS = register("white_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> YELLOW_STAINED_GLASS = register("yellow_stained_glass", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> ACACIA_WINDOW_BARS_SIDE = register("acacia_window_bars_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> ACACIA_WINDOW_COVERED_SIDE = register("acacia_window_covered_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> ACACIA_WINDOW_DIAGONAL_SIDE = register("acacia_window_diagonal_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> ACACIA_WINDOW_LARGE_SIDE = register("acacia_window_large_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> ACACIA_WINDOW_PANES_SIDE = register("acacia_window_panes_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> ACACIA_WINDOW_ROUNDED_SIDE = register("acacia_window_rounded_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> ACACIA_WINDOW_SLIM_SIDE = register("acacia_window_slim_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> ACACIA_WINDOW_SWIRLING_SIDE = register("acacia_window_swirling_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> AMETHYST_BLOCK_PILLAR_END = register("amethyst_block_pillar_end", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BIRCH_WINDOW_BARS_SIDE = register("birch_window_bars_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BIRCH_WINDOW_COVERED_SIDE = register("birch_window_covered_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BIRCH_WINDOW_DIAGONAL_SIDE = register("birch_window_diagonal_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BIRCH_WINDOW_LARGE_SIDE = register("birch_window_large_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BIRCH_WINDOW_PANES_SIDE = register("birch_window_panes_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BIRCH_WINDOW_ROUNDED_SIDE = register("birch_window_rounded_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BIRCH_WINDOW_SLIM_SIDE = register("birch_window_slim_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BIRCH_WINDOW_SWIRLING_SIDE = register("birch_window_swirling_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> BONE_BLOCK_CONNECTING_SIDE = register("bone_block_connecting_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CRIMSON_WINDOW_BARS_SIDE = register("crimson_window_bars_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CRIMSON_WINDOW_COVERED_SIDE = register("crimson_window_covered_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CRIMSON_WINDOW_DIAGONAL_SIDE = register("crimson_window_diagonal_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CRIMSON_WINDOW_LARGE_SIDE = register("crimson_window_large_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CRIMSON_WINDOW_PANES_SIDE = register("crimson_window_panes_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CRIMSON_WINDOW_ROUNDED_SIDE = register("crimson_window_rounded_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CRIMSON_WINDOW_SLIM_SIDE = register("crimson_window_slim_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> CRIMSON_WINDOW_SWIRLING_SIDE = register("crimson_window_swirling_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> DARK_OAK_WINDOW_BARS_SIDE = register("dark_oak_window_bars_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> DARK_OAK_WINDOW_COVERED_SIDE = register("dark_oak_window_covered_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> DARK_OAK_WINDOW_DIAGONAL_SIDE = register("dark_oak_window_diagonal_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> DARK_OAK_WINDOW_LARGE_SIDE = register("dark_oak_window_large_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> DARK_OAK_WINDOW_PANES_SIDE = register("dark_oak_window_panes_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> DARK_OAK_WINDOW_ROUNDED_SIDE = register("dark_oak_window_rounded_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> DARK_OAK_WINDOW_SLIM_SIDE = register("dark_oak_window_slim_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> DARK_OAK_WINDOW_SWIRLING_SIDE = register("dark_oak_window_swirling_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> EMERALD_BLOCK_PILLAR_END = register("emerald_block_pillar_end", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> INDUSTRIAL_IRON_WINDOW_CONNECTED = register("industrial_iron_window_connected", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> JUNGLE_WINDOW_BARS_SIDE = register("jungle_window_bars_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> JUNGLE_WINDOW_COVERED_SIDE = register("jungle_window_covered_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> JUNGLE_WINDOW_DIAGONAL_SIDE = register("jungle_window_diagonal_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> JUNGLE_WINDOW_LARGE_SIDE = register("jungle_window_large_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> JUNGLE_WINDOW_PANES_SIDE = register("jungle_window_panes_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> JUNGLE_WINDOW_ROUNDED_SIDE = register("jungle_window_rounded_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> JUNGLE_WINDOW_SLIM_SIDE = register("jungle_window_slim_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> JUNGLE_WINDOW_SWIRLING_SIDE = register("jungle_window_swirling_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> MANGROVE_WINDOW_BARS_SIDE = register("mangrove_window_bars_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> MANGROVE_WINDOW_COVERED_SIDE = register("mangrove_window_covered_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> MANGROVE_WINDOW_DIAGONAL_SIDE = register("mangrove_window_diagonal_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> MANGROVE_WINDOW_LARGE_SIDE = register("mangrove_window_large_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> MANGROVE_WINDOW_PANES_SIDE = register("mangrove_window_panes_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> MANGROVE_WINDOW_ROUNDED_SIDE = register("mangrove_window_rounded_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> MANGROVE_WINDOW_SLIM_SIDE = register("mangrove_window_slim_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> MANGROVE_WINDOW_SWIRLING_SIDE = register("mangrove_window_swirling_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> OAK_WINDOW_BARS_SIDE = register("oak_window_bars_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> OAK_WINDOW_COVERED_SIDE = register("oak_window_covered_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> OAK_WINDOW_DIAGONAL_SIDE = register("oak_window_diagonal_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> OAK_WINDOW_LARGE_SIDE = register("oak_window_large_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> OAK_WINDOW_PANES_SIDE = register("oak_window_panes_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> OAK_WINDOW_ROUNDED_SIDE = register("oak_window_rounded_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> OAK_WINDOW_SLIM_SIDE = register("oak_window_slim_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> OAK_WINDOW_SWIRLING_SIDE = register("oak_window_swirling_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> REDSTONE_BLOCK_PILLAR_END = register("redstone_block_pillar_end", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<Block> SPRUCE_WINDOW_BARS_SIDE = register("spruce_window_bars_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SPRUCE_WINDOW_COVERED_SIDE = register("spruce_window_covered_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SPRUCE_WINDOW_DIAGONAL_SIDE = register("spruce_window_diagonal_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SPRUCE_WINDOW_LARGE_SIDE = register("spruce_window_large_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SPRUCE_WINDOW_PANES_SIDE = register("spruce_window_panes_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SPRUCE_WINDOW_ROUNDED_SIDE = register("spruce_window_rounded_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SPRUCE_WINDOW_SLIM_SIDE = register("spruce_window_slim_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> SPRUCE_WINDOW_SWIRLING_SIDE = register("spruce_window_swirling_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> WARPED_WINDOW_BARS_SIDE = register("warped_window_bars_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> WARPED_WINDOW_COVERED_SIDE = register("warped_window_covered_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> WARPED_WINDOW_DIAGONAL_SIDE = register("warped_window_diagonal_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> WARPED_WINDOW_LARGE_SIDE = register("warped_window_large_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> WARPED_WINDOW_PANES_SIDE = register("warped_window_panes_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> WARPED_WINDOW_ROUNDED_SIDE = register("warped_window_rounded_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> WARPED_WINDOW_SLIM_SIDE = register("warped_window_slim_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> WARPED_WINDOW_SWIRLING_SIDE = register("warped_window_swirling_side", () -> new Block(Properties.ofFullCopy(Blocks.STONE)));
