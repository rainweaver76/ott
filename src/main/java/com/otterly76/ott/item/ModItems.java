...
public static final DeferredHolder<Item, BlockItem> WARPED_PLANKS_PANEL =
    ...
    public static final DeferredHolder<Item, BlockItem> CURLY_STONE_CTM                = registerBlockItem("curly_stone_ctm",                ModBlocks.CURLY_STONE_CTM);
    ...
    public static final DeferredHolder<Item, BlockItem> FINE_STONE_CTM                 = registerBlockItem("fine_stone_ctm",                 ModBlocks.FINE_STONE_CTM);
    ...
    public static final DeferredHolder<Item, BlockItem> ORNATE_STONE_CTM               = registerBlockItem("ornate_stone_ctm",               ModBlocks.ORNATE_STONE_CTM);
    ...
    public static final DeferredHolder<Item, BlockItem> SIMPLE_STONE_CTM               = registerBlockItem("simple_stone_ctm",               ModBlocks.SIMPLE_STONE_CTM);
    ...
    public static final DeferredHolder<Item, BlockItem> ORIG_POLISHED_ANDESITE_CTM              = registerBlockItem("polished_andesite",       ModBlocks.ORIG_POLISHED_ANDESITE_CTM);
    public static final DeferredHolder<Item, BlockItem> ORIG_POLISHED_BLACKSTONE_CTM            = registerBlockItem("polished_blackstone",     ModBlocks.ORIG_POLISHED_BLACKSTONE_CTM);
    public static final DeferredHolder<Item, BlockItem> ORIG_POLISHED_DIORITE_CTM               = registerBlockItem("polished_diorite",        ModBlocks.ORIG_POLISHED_DIORITE_CTM);
    public static final DeferredHolder<Item, BlockItem> ORIG_POLISHED_GRANITE_CTM               = registerBlockItem("polished_granite",        ModBlocks.ORIG_POLISHED_GRANITE_CTM);
    public static final DeferredHolder<Item, BlockItem> ORIG_NETHERITE_BLOCK_CTM                = registerBlockItem("netherite_block",         ModBlocks.ORIG_NETHERITE_BLOCK_CTM);
    public static final DeferredHolder<Item, BlockItem> ORIG_SMOOTH_STONE_CTM                   = registerBlockItem("smooth_stone",            ModBlocks.ORIG_SMOOTH_STONE_CTM);
    public static final DeferredHolder<Item, BlockItem> ORIG_EMERALD_BLOCK_CTM                  = registerBlockItem("emerald_block",           ModBlocks.ORIG_EMERALD_BLOCK_CTM);
    ...
    public static final DeferredHolder<Item, BlockItem> BONE_BLOCK_CTM        = registerBlockItem("bone_block_ctm",        ModBlocks.BONE_BLOCK_CTM);
    public static final DeferredHolder<Item, BlockItem> COAL_BLOCK_CTM        = registerBlockItem("coal_block_ctm",        ModBlocks.COAL_BLOCK_CTM);
    public static final DeferredHolder<Item, BlockItem> COBBLED_DEEPSLATE_CTM = registerBlockItem("cobbled_deepslate_ctm", ModBlocks.COBBLED_DEEPSLATE_CTM);
    public static final DeferredHolder<Item, BlockItem> COBBLESTONE_CTM       = registerBlockItem("cobblestone_ctm",       ModBlocks.COBBLESTONE_CTM);
    public static final DeferredHolder<Item, BlockItem> COPPER_BLOCK_CTM      = registerBlockItem("copper_block_ctm",      ModBlocks.COPPER_BLOCK_CTM);
    public static final DeferredHolder<Item, BlockItem> LAPIS_BLOCK_CTM       = registerBlockItem("lapis_block_ctm",       ModBlocks.LAPIS_BLOCK_CTM);
    public static final DeferredHolder<Item, BlockItem> NETHERITE_BLOCK_CTM   = registerBlockItem("netherite_block_ctm",   ModBlocks.NETHERITE_BLOCK_CTM);
    public static final DeferredHolder<Item, BlockItem> OBSIDIAN_CTM          = registerBlockItem("obsidian_ctm",          ModBlocks.OBSIDIAN_CTM);
