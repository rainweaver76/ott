...
public class ModItems {
    ...
    public static final DeferredHolder<Item, BlockItem> LAPIS_BLOCK_CHISELED = registerBlockItem("lapis_block_chiseled", ModBlocks.LAPIS_BLOCK_CHISELED);
    ...
    public static final DeferredHolder<Item, BlockItem> BONE_BLOCK_CONNECTING_END = registerBlockItem("bone_block_connecting_end", ModBlocks.BONE_BLOCK_CONNECTING_END);
    ...
    public static final DeferredHolder<Item, BlockItem> BONE_BLOCK_PILLAR_END = registerBlockItem("bone_block_pillar_end", ModBlocks.BONE_BLOCK_PILLAR_END);
    ...
    public static final DeferredHolder<Item, BlockItem> COAL_BLOCK_PILLAR_END = registerBlockItem("coal_block_pillar_end", ModBlocks.COAL_BLOCK_PILLAR_END);
    ...
    public static final DeferredHolder<Item, BlockItem> COBBLED_DEEPSLATE_PILLAR_END = registerBlockItem("cobbled_deepslate_pillar_end", ModBlocks.COBBLED_DEEPSLATE_PILLAR_END);
    ...
    public static final DeferredHolder<Item, BlockItem> COBBLESTONE_PILLAR_END = registerBlockItem("cobblestone_pillar_end", ModBlocks.COBBLESTONE_PILLAR_END);
    ...
    public static final DeferredHolder<Item, BlockItem> COPPER_BLOCK_PILLAR_END = registerBlockItem("copper_block_pillar_end", ModBlocks.COPPER_BLOCK_PILLAR_END);
    ...
    public static final DeferredHolder<Item, BlockItem> LAPIS_BLOCK_PILLAR_END = registerBlockItem("lapis_block_pillar_end", ModBlocks.LAPIS_BLOCK_PILLAR_END);
    ...
    public static final DeferredHolder<Item, BlockItem> NETHERITE_BLOCK_PILLAR_END = registerBlockItem("netherite_block_pillar_end", ModBlocks.NETHERITE_BLOCK_PILLAR_END);
    ...
    public static final DeferredHolder<Item, BlockItem> ACACIA_WINDOW_BARS_SIDE = registerBlockItem("acacia_window_bars_side", ModBlocks.ACACIA_WINDOW_BARS_SIDE);
    public static final DeferredHolder<Item, BlockItem> ACACIA_WINDOW_COVERED_SIDE = registerBlockItem("acacia_window_covered_side", ModBlocks.ACACIA_WINDOW_COVERED_SIDE);
    public static final DeferredHolder<Item, BlockItem> ACACIA_WINDOW_DIAGONAL_SIDE = registerBlockItem("acacia_window_diagonal_side", ModBlocks.ACACIA_WINDOW_DIAGONAL_SIDE);
    public static final DeferredHolder<Item, BlockItem> ACACIA_WINDOW_LARGE_SIDE = registerBlockItem("acacia_window_large_side", ModBlocks.ACACIA_WINDOW_LARGE_SIDE);
    public static final DeferredHolder<Item, BlockItem> ACACIA_WINDOW_PANES_SIDE = registerBlockItem("acacia_window_panes_side", ModBlocks.ACACIA_WINDOW_PANES_SIDE);
    ...
    public static final DeferredHolder<Item, BlockItem> BIRCH_WINDOW_LARGE_SIDE = registerBlockItem("birch_window_large_side", ModBlocks.BIRCH_WINDOW_LARGE_SIDE);
    public static final DeferredHolder<Item, BlockItem> BIRCH_WINDOW_PANES_SIDE = registerBlockItem("birch_window_panes_side", ModBlocks.BIRCH_WINDOW_PANES_SIDE);
    public static final DeferredHolder<Item, BlockItem> BIRCH_WINDOW_ROUNDED_SIDE = registerBlockItem("birch_window_rounded_side", ModBlocks.BIRCH_WINDOW_ROUNDED_SIDE);
    public static final DeferredHolder<Item, BlockItem> BIRCH_WINDOW_SLIM_SIDE = registerBlockItem("birch_window_slim_side", ModBlocks.BIRCH_WINDOW_SLIM_SIDE);
    public static final DeferredHolder<Item, BlockItem> BIRCH_WINDOW_SWIRLING_SIDE = registerBlockItem("birch_window_swirling_side", ModBlocks.BIRCH_WINDOW_SWIRLING_SIDE);
    public static final DeferredHolder<Item, BlockItem> BONE_BLOCK_CONNECTING_SIDE = registerBlockItem("bone_block_connecting_side", ModBlocks.BONE_BLOCK_CONNECTING_SIDE);
    public static final DeferredHolder<Item, BlockItem> CRIMSON_WINDOW_BARS_SIDE = registerBlockItem("crimson_window_bars_side", ModBlocks.CRIMSON_WINDOW_BARS_SIDE);
    public static final DeferredHolder<Item, BlockItem> CRIMSON_WINDOW_COVERED_SIDE = registerBlockItem("crimson_window_covered_side", ModBlocks.CRIMSON_WINDOW_COVERED_SIDE);
    public static final DeferredHolder<Item, BlockItem> CRIMSON_WINDOW_DIAGONAL_SIDE = registerBlockItem("crimson_window_diagonal_side", ModBlocks.CRIMSON_WINDOW_DIAGONAL_SIDE);
    public static final DeferredHolder<Item, BlockItem> CRIMSON_WINDOW_LARGE_SIDE = registerBlockItem("crimson_window_large_side", ModBlocks.CRIMSON_WINDOW_LARGE_SIDE);
    public static final DeferredHolder<Item, BlockItem> CRIMSON_WINDOW_PANES_SIDE = registerBlockItem("crimson_window_panes_side", ModBlocks.CRIMSON_WINDOW_PANES_SIDE);
    public static final DeferredHolder<Item, BlockItem> CRIMSON_WINDOW_ROUNDED_SIDE = registerBlockItem("crimson_window_rounded_side", ModBlocks.CRIMSON_WINDOW_ROUNDED_SIDE);
    public static final DeferredHolder<Item, BlockItem> CRIMSON_WINDOW_SLIM_SIDE = registerBlockItem("crimson_window_slim_side", ModBlocks.CRIMSON_WINDOW_SLIM_SIDE);
    public static final DeferredHolder<Item, BlockItem> CRIMSON_WINDOW_SWIRLING_SIDE = registerBlockItem("crimson_window_swirling_side", ModBlocks.CRIMSON_WINDOW_SWIRLING_SIDE);
    public static final DeferredHolder<Item, BlockItem> DARK_OAK_WINDOW_BARS_SIDE = registerBlockItem("dark_oak_window_bars_side", ModBlocks.DARK_OAK_WINDOW_BARS_SIDE);
    public static final DeferredHolder<Item, BlockItem> DARK_OAK_WINDOW_COVERED_SIDE = registerBlockItem("dark_oak_window_covered_side", ModBlocks.DARK_OAK_WINDOW_COVERED_SIDE);
    public static final DeferredHolder<Item, BlockItem> DARK_OAK_WINDOW_DIAGONAL_SIDE = registerBlockItem("dark_oak_window_diagonal_side", ModBlocks.DARK_OAK_WINDOW_DIAGONAL_SIDE);
    public static final DeferredHolder<Item, BlockItem> DARK_OAK_WINDOW_LARGE_SIDE = registerBlockItem("dark_oak_window_large_side", ModBlocks.DARK_OAK_WINDOW_LARGE_SIDE);
    public static final DeferredHolder<Item, BlockItem> DARK_OAK_WINDOW_PANES_SIDE = registerBlockItem("dark_oak_window_panes_side", ModBlocks.DARK_OAK_WINDOW_PANES_SIDE);
    ...
    public static final DeferredHolder<Item, BlockItem> JUNGLE_WINDOW_DIAGONAL_SIDE = registerBlockItem("jungle_window_diagonal_side", ModBlocks.JUNGLE_WINDOW_DIAGONAL_SIDE);
    public static final DeferredHolder<Item, BlockItem> JUNGLE_WINDOW_LARGE_SIDE = registerBlockItem("jungle_window_large_side", ModBlocks.JUNGLE_WINDOW_LARGE_SIDE);
    public static final DeferredHolder<Item, BlockItem> JUNGLE_WINDOW_PANES_SIDE = registerBlockItem("jungle_window_panes_side", ModBlocks.JUNGLE_WINDOW_PANES_SIDE);
    public static final DeferredHolder<Item, BlockItem> JUNGLE_WINDOW_ROUNDED_SIDE = registerBlockItem("jungle_window_rounded_side", ModBlocks.JUNGLE_WINDOW_ROUNDED_SIDE);
    public static final DeferredHolder<Item, BlockItem> JUNGLE_WINDOW_SLIM_SIDE = registerBlockItem("jungle_window_slim_side", ModBlocks.JUNGLE_WINDOW_SLIM_SIDE);
    public static final DeferredHolder<Item, BlockItem> JUNGLE_WINDOW_SWIRLING_SIDE = registerBlockItem("jungle_window_swirling_side", ModBlocks.JUNGLE_WINDOW_SWIRLING_SIDE);
    public static final DeferredHolder<Item, BlockItem> MANGROVE_WINDOW_BARS_SIDE = registerBlockItem("mangrove_window_bars_side", ModBlocks.MANGROVE_WINDOW_BARS_SIDE);
    public static final DeferredHolder<Item, BlockItem> MANGROVE_WINDOW_COVERED_SIDE = registerBlockItem("mangrove_window_covered_side", ModBlocks.MANGROVE_WINDOW_COVERED_SIDE);
    public static final DeferredHolder<Item, BlockItem> MANGROVE_WINDOW_DIAGONAL_SIDE = registerBlockItem("mangrove_window_diagonal_side", ModBlocks.MANGROVE_WINDOW_DIAGONAL_SIDE);
    public static final DeferredHolder<Item, BlockItem> MANGROVE_WINDOW_LARGE_SIDE = registerBlockItem("mangrove_window_large_side", ModBlocks.MANGROVE_WINDOW_LARGE_SIDE);
    public static final DeferredHolder<Item, BlockItem> MANGROVE_WINDOW_PANES_SIDE = registerBlockItem("mangrove_window_panes_side", ModBlocks.MANGROVE_WINDOW_PANES_SIDE);
    public static final DeferredHolder<Item, BlockItem> MANGROVE_WINDOW_ROUNDED_SIDE = registerBlockItem("mangrove_window_rounded_side", ModBlocks.MANGROVE_WINDOW_ROUNDED_SIDE);
    public static final DeferredHolder<Item, BlockItem> MANGROVE_WINDOW_SLIM_SIDE = registerBlockItem("mangrove_window_slim_side", ModBlocks.MANGROVE_WINDOW_SLIM_SIDE);
    public static final DeferredHolder<Item, BlockItem> MANGROVE_WINDOW_SWIRLING_SIDE = registerBlockItem("mangrove_window_swirling_side", ModBlocks.MANGROVE_WINDOW_SWIRLING_SIDE);
    public static final DeferredHolder<Item, BlockItem> OAK_WINDOW_BARS_SIDE = registerBlockItem("oak_window_bars_side", ModBlocks.OAK_WINDOW_BARS_SIDE);
    public static final DeferredHolder<Item, BlockItem> OAK_WINDOW_COVERED_SIDE = registerBlockItem("oak_window_covered_side", ModBlocks.OAK_WINDOW_COVERED_SIDE);
    public static final DeferredHolder<Item, BlockItem> OAK_WINDOW_DIAGONAL_SIDE = registerBlockItem("oak_window_diagonal_side", ModBlocks.OAK_WINDOW_DIAGONAL_SIDE);
    public static final DeferredHolder<Item, BlockItem> OAK_WINDOW_LARGE_SIDE = registerBlockItem("oak_window_large_side", ModBlocks.OAK_WINDOW_LARGE_SIDE);
    public static final DeferredHolder<Item, BlockItem> OAK_WINDOW_PANES_SIDE = registerBlockItem("oak_window_panes_side", ModBlocks.OAK_WINDOW_PANES_SIDE);
    ...
    public static final DeferredHolder<Item, BlockItem> SPRUCE_WINDOW_DIAGONAL_SIDE = registerBlockItem("spruce_window_diagonal_side", ModBlocks.SPRUCE_WINDOW_DIAGONAL_SIDE);
    public static final DeferredHolder<Item, BlockItem> SPRUCE_WINDOW_LARGE_SIDE = registerBlockItem("spruce_window_large_side", ModBlocks.SPRUCE_WINDOW_LARGE_SIDE);
    public static final DeferredHolder<Item, BlockItem> SPRUCE_WINDOW_PANES_SIDE = registerBlockItem("spruce_window_panes_side", ModBlocks.SPRUCE_WINDOW_PANES_SIDE);
    public static final DeferredHolder<Item, BlockItem> SPRUCE_WINDOW_ROUNDED_SIDE = registerBlockItem("spruce_window_rounded_side", ModBlocks.SPRUCE_WINDOW_ROUNDED_SIDE);
    public static final DeferredHolder<Item, BlockItem> SPRUCE_WINDOW_SLIM_SIDE = registerBlockItem("spruce_window_slim_side", ModBlocks.SPRUCE_WINDOW_SLIM_SIDE);
    public static final DeferredHolder<Item, BlockItem> SPRUCE_WINDOW_SWIRLING_SIDE = registerBlockItem("spruce_window_swirling_side", ModBlocks.SPRUCE_WINDOW_SWIRLING_SIDE);
    public static final DeferredHolder<Item, BlockItem> WARPED_WINDOW_BARS_SIDE = registerBlockItem("warped_window_bars_side", ModBlocks.WARPED_WINDOW_BARS_SIDE);
    public static final DeferredHolder<Item, BlockItem> WARPED_WINDOW_COVERED_SIDE = registerBlockItem("warped_window_covered_side", ModBlocks.WARPED_WINDOW_COVERED_SIDE);
    public static final DeferredHolder<Item, BlockItem> WARPED_WINDOW_DIAGONAL_SIDE = registerBlockItem("warped_window_diagonal_side", ModBlocks.WARPED_WINDOW_DIAGONAL_SIDE);
    public static final DeferredHolder<Item, BlockItem> WARPED_WINDOW_LARGE_SIDE = registerBlockItem("warped_window_large_side", ModBlocks.WARPED_WINDOW_LARGE_SIDE);
    public static final DeferredHolder<Item, BlockItem> WARPED_WINDOW_PANES_SIDE = registerBlockItem("warped_window_panes_side", ModBlocks.WARPED_WINDOW_PANES_SIDE);
    public static final DeferredHolder<Item, BlockItem> WARPED_WINDOW_ROUNDED_SIDE = registerBlockItem("warped_window_rounded_side", ModBlocks.WARPED_WINDOW_ROUNDED_SIDE);
    public static final DeferredHolder<Item, BlockItem> WARPED_WINDOW_SLIM_SIDE = registerBlockItem("warped_window_slim_side", ModBlocks.WARPED_WINDOW_SLIM_SIDE);
    public static final DeferredHolder<Item, BlockItem> WARPED_WINDOW_SWIRLING_SIDE = registerBlockItem("warped_window_swirling_side", ModBlocks.WARPED_WINDOW_SWIRLING_SIDE);
