...
public enum CtmLayout {
    ...
    public static CtmLayout fromId(String id) {
        return switch (id.toLowerCase()) {
            ...
            case "giant"      -> GIANT;
            // "vertical" = the vertical glass/window PANE alias for the 4×1 (64×16) pillar strip.
            // Same atlas as PIECES_VERTICAL; the ctm_pane_*_vertical templates sample a centre slice
            // of tile 0 at full height and rely on remapQuad to shift to the up/down-selected tile.
            case "vertical", "pieces_vertical" -> PIECES_VERTICAL;
